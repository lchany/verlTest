...
ascendfactory-cli train /home/l30002999/yaml/verl_qwen3_vl-4b_ppo_fsdp.yaml \
    ...
    --backend_config.trainer.save_freq=-1 \
    --backend_config.trainer.total_training_steps=5 \
