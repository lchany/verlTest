...
# 路径配置
# ============================================================
MODEL_PATH=/data/nfs/model/Qwen3-VL-4B-Instruct
CKPTS_DIR=/data/nfs/l30002999/checkpoints/qwen3vl_4b_grpo_2npu
...
exp_name='GRPO-Qwen3_vl-4B-2npu'
...
python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.ascend_memory_optimizer=False \
